package com.uottawa.ahmadsoboh.lab4;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        // Initialize drawableName to a default value
        String drawableName = "ic_logo_00";

        // Use if-else statements to determine the selected image
        int imageID = data.getIntExtra("imageID", -1); // Default to an invalid value

        if (imageID == R.id.logoImage01) {
